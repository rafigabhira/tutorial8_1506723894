...
//    }
    ...
    @RequestMapping(value = "/admin/pilot/add", method = RequestMethod.GET)
    private String add(Model model) {
        model.addAttribute("pilot", new PilotModel());
        return "add-pilot";
    }

    @RequestMapping(value = "/admin/pilot/add", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/admin/pilot/delete", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/admin/pilot/update", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/admin/pilot/update", method = RequestMethod.POST)
